...
def crawl(media_code, **kwargs):
    ...
    s3 = boto3.resource('s3',
        endpoint_url = conn.extra_dejson['host'],
...
def temp_json_to_parquet(media_code, **kwargs):
    ...
    with TemporaryDirectory() as temp_dir:
        ...
        s3.meta.client.upload_file(str(file_path), 'ingtranet-raw-data', f'daum_news/media_code={media_code}/date={execution_date.format("%Y%m%d")}/0.gzip.parquet')
